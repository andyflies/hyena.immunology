# source("f.lmer.single.categorical.variable.model.backup.r")
...
f.lmer.single.categorical.variable.model <- function(df.input, ...)   
{
...
#  c.data.set.name <- "full.set"
  c.data.set.name <- "full.male.female.set"

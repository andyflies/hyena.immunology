...
f.clmm.female.models <- function(df.input, ...)   
{
...
#    for(i.counter.2 in 1:cv.dependent.variables)  {
    for(i.counter.2 in i.counter.2:i.counter.2.stop)  {
      ...
      print(df.temp)
      df.temp <- df.temp[!is.na(df.temp$i.rank),]
...
#      df.temp <- df.temp[!is.na(df.temp$c.reproductive.status),]
      ...
      clm2.rank <- clm2(d.dependent.factor ~ i.rank, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible") #, nAGQ = 10)
      clmm2.rank <- clmm2(d.dependent.factor ~ i.rank, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
...
# print(anova(clmn.1, clmm2.2))
      clm2.0 <- clm2(d.dependent.factor ~ 1, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.0 <- clmm2(d.dependent.factor ~ 1, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.0))
      print(summary(clmm2.0))
      print(anova(clm2.0, clmm2.0))

      clm2.repro <- clm2(d.dependent.factor ~ c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.repro <- clmm2(d.dependent.factor ~ c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      ...
      clm2.rank.prey.1 <- clm2(d.dependent.factor ~ i.rank + d.prey.density, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible") #, nAGQ = 10)
      clmm2.rank.prey.1 <- clmm2(d.dependent.factor ~ i.rank + d.prey.density, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.rank.prey.1))
      print(summary(clmm2.rank.prey.1))
      print(anova(clm2.rank.prey.1, clmm2.rank.prey.1))

      clm2.rank.prey.2 <- clm2(d.dependent.factor ~ i.rank * d.prey.density, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible") #, nAGQ = 10)
      clmm2.rank.prey.2 <- clmm2(d.dependent.factor ~ i.rank * d.prey.density, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.rank.prey.2))
      print(summary(clmm2.rank.prey.2))
      print(anova(clm2.rank.prey.2, clmm2.rank.prey.2))

      clm2.rank.age.1 <- clm2(d.dependent.factor ~ i.rank + d.age.months, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible") #, nAGQ = 10)
      clmm2.rank.age.1 <- clmm2(d.dependent.factor ~ i.rank + d.age.months, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.rank.age.1))
      print(summary(clmm2.rank.age.1))
      print(anova(clm2.rank.age.1, clmm2.rank.age.1))

      clm2.rank.repro.1 <- clm2(d.dependent.factor ~ i.rank + c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible") #, nAGQ = 10)
      clmm2.rank.repro.1 <- clmm2(d.dependent.factor ~ i.rank + c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.rank.repro.1))
      print(summary(clmm2.rank.repro.1))
      print(anova(clm2.rank.repro.1, clmm2.rank.repro.1))

      clm2.rank.repro.2 <- clm2(d.dependent.factor ~ i.rank * c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible") #, nAGQ = 10)
      clmm2.rank.repro.2 <- clmm2(d.dependent.factor ~ i.rank * c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.rank.repro.2))
      print(summary(clmm2.rank.repro.2))
      print(anova(clm2.rank.repro.2, clmm2.rank.repro.2))

#      clmm2.date.rank.repro.2 <- clmm2(d.dependent.factor ~ d.independent + i.rank * c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      clm2.rank.prey.repro.1 <- clm2(d.dependent.factor ~ i.rank + d.prey.density + c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible") #, nAGQ = 10)
      clmm2.rank.prey.repro.1 <- clmm2(d.dependent.factor ~ i.rank + d.prey.density + c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      ...
      clm2.rank.prey.repro.2 <- clm2(d.dependent.factor ~ i.rank * d.prey.density +  c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible") #, nAGQ = 10)
      clmm2.rank.prey.repro.2 <- clmm2(d.dependent.factor ~ i.rank * d.prey.density +  c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      ...
      clm2.rank.prey.repro.12 <- clm2(d.dependent.factor ~ i.rank + d.prey.density * c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible") #, nAGQ = 10)
      clmm2.rank.prey.repro.12 <- clmm2(d.dependent.factor ~ i.rank + d.prey.density * c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      ...
      clm2.rank.prey.repro.22 <- clm2(d.dependent.factor ~ i.rank * d.prey.density + d.prey.density * c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible") #, nAGQ = 10)
      clmm2.rank.prey.repro.22 <- clmm2(d.dependent.factor ~ i.rank * d.prey.density + d.prey.density * c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      ...
      clm2.rank.age.repro.1 <- clm2(d.dependent.factor ~ i.rank + d.age.months +  c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible") #, nAGQ = 10)
      clmm2.rank.age.repro.1 <- clmm2(d.dependent.factor ~ i.rank + d.age.months +  c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      ...
      clm2.date.rank.1 <- clm2(d.dependent.factor ~ d.independent + i.rank, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.date.rank.1 <- clmm2(d.dependent.factor ~ d.independent + i.rank, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      ...
      clm2.date.repro.1 <- clm2(d.dependent.factor ~ d.independent + c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.date.repro.1 <- clmm2(d.dependent.factor ~ d.independent + c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.date.repro.1))
      print(summary(clmm2.date.repro.1))
      print(anova(clm2.date.repro.1, clmm2.date.repro.1))

      clm2.date.rank.prey.1 <- clm2(d.dependent.factor ~ d.independent + i.rank + d.prey.density, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.date.rank.prey.1 <- clmm2(d.dependent.factor ~ d.independent + i.rank + d.prey.density, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.date.rank.prey.1))
      print(summary(clmm2.date.rank.prey.1))
      print(anova(clm2.date.rank.prey.1, clmm2.date.rank.prey.1))

      clm2.date.rank.prey.2 <- clm2(d.dependent.factor ~ d.independent + i.rank * d.prey.density, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.date.rank.prey.2 <- clmm2(d.dependent.factor ~ d.independent + i.rank * d.prey.density, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.date.rank.prey.2))
      print(summary(clmm2.date.rank.prey.2))
      print(anova(clm2.date.rank.prey.2, clmm2.date.rank.prey.2))

      clm2.date.rank.age.1 <- clm2(d.dependent.factor ~ d.independent + i.rank + d.age.months, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.date.rank.age.1 <- clmm2(d.dependent.factor ~ d.independent + i.rank + d.age.months, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.date.rank.age.1))
      print(summary(clmm2.date.rank.age.1))
      print(anova(clm2.date.rank.age.1, clmm2.date.rank.age.1))

      clm2.date.rank.repro.1 <- clm2(d.dependent.factor ~ d.independent + i.rank + c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.date.rank.repro.1 <- clmm2(d.dependent.factor ~ d.independent + i.rank + c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.date.rank.repro.1))
      print(summary(clmm2.date.rank.repro.1))
      print(anova(clm2.date.rank.repro.1, clmm2.date.rank.repro.1))

      clm2.date.rank.prey.repro.1 <- clm2(d.dependent.factor ~ d.independent + i.rank + d.prey.density + c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.date.rank.prey.repro.1 <- clmm2(d.dependent.factor ~ d.independent + i.rank + d.prey.density + c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.date.rank.prey.repro.1))
      print(summary(clmm2.date.rank.prey.repro.1))
      print(anova(clm2.date.rank.prey.repro.1, clmm2.date.rank.prey.repro.1))

      clm2.date.rank.prey.repro.2 <- clm2(d.dependent.factor ~ d.independent + i.rank * d.prey.density +  c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.date.rank.prey.repro.2 <- clmm2(d.dependent.factor ~ d.independent + i.rank * d.prey.density +  c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.date.rank.prey.repro.2))
      print(summary(clmm2.date.rank.prey.repro.2))
      print(anova(clm2.date.rank.prey.repro.2, clmm2.date.rank.prey.repro.2))

      clm2.date.rank.prey.repro.12 <- clm2(d.dependent.factor ~ d.independent + i.rank + d.prey.density * c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.date.rank.prey.repro.12 <- clmm2(d.dependent.factor ~ d.independent + i.rank + d.prey.density * c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.date.rank.prey.repro.12))
      print(summary(clmm2.date.rank.prey.repro.12))
      print(anova(clm2.date.rank.prey.repro.12, clmm2.date.rank.prey.repro.12))

      clm2.date.rank.prey.repro.22 <- clm2(d.dependent.factor ~ d.independent + i.rank * d.prey.density + d.prey.density * c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.date.rank.prey.repro.22 <- clmm2(d.dependent.factor ~ d.independent + i.rank * d.prey.density + d.prey.density * c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.date.rank.prey.repro.22))
      print(summary(clmm2.date.rank.prey.repro.22))
      print(anova(clm2.date.rank.prey.repro.22, clmm2.date.rank.prey.repro.22))

      clm2.date.rank.age.repro.1 <- clm2(d.dependent.factor ~ d.independent + i.rank + d.age.months +  c.reproductive.status, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible")
      clmm2.date.rank.age.repro.1 <- clmm2(d.dependent.factor ~ d.independent + i.rank + d.age.months +  c.reproductive.status, random = c.id, data = df.temp, Hess = TRUE, link = "logistic", threshold = "flexible", nAGQ = 10)
      print(summary(clm2.date.rank.age.repro.1))
      print(summary(clmm2.date.rank.age.repro.1))
      print(anova(clm2.date.rank.age.repro.1, clmm2.date.rank.age.repro.1))
...
print("test25")
      lmer.rank.prey.1 <- lmer(d.dependent ~ i.rank + d.prey.density + (1 | c.id), data = df.temp)
      lmer.rank.prey.2 <- lmer(d.dependent ~ i.rank * d.prey.density + (1 | c.id), data = df.temp)
      lmer.rank.age.1 <- lmer(d.dependent ~ i.rank + d.age.months + (1 | c.id), data = df.temp)
      lmer.rank.repro.1 <- lmer(d.dependent ~ i.rank + c.reproductive.status + (1 | c.id), data = df.temp)
      lmer.rank.repro.2 <- lmer(d.dependent ~ i.rank * c.reproductive.status + (1 | c.id), data = df.temp)

      lmer.date.rank.prey.1 <- lmer(d.dependent ~ d.independent + i.rank + d.prey.density + (1 | c.id), data = df.temp)
      lmer.date.rank.prey.2 <- lmer(d.dependent ~ d.independent + i.rank * d.prey.density + (1 | c.id), data = df.temp)
      lmer.date.rank.age.1 <- lmer(d.dependent ~ d.independent + i.rank + d.age.months + (1 | c.id), data = df.temp)
      lmer.date.rank.repro.1 <- lmer(d.dependent ~ d.independent + i.rank + c.reproductive.status + (1 | c.id), data = df.temp)
      lmer.date.rank.repro.2 <- lmer(d.dependent ~ d.independent + i.rank * c.reproductive.status + (1 | c.id), data = df.temp)
print("test30")
      lmer.rank.prey.repro.1 <- lmer(d.dependent ~ i.rank + d.prey.density + c.reproductive.status + (1 | c.id), data = df.temp)
      lmer.rank.prey.repro.2 <- lmer(d.dependent ~ i.rank * d.prey.density +  c.reproductive.status +  (1 | c.id), data = df.temp)
      lmer.rank.prey.repro.12 <- lmer(d.dependent ~ i.rank + d.prey.density * c.reproductive.status +  (1 | c.id), data = df.temp)
      lmer.rank.prey.repro.22 <- lmer(d.dependent ~ i.rank * d.prey.density + d.prey.density * c.reproductive.status +  (1 | c.id), data = df.temp)
      lmer.rank.age.repro.1 <- lmer(d.dependent ~ i.rank + d.age.months +  c.reproductive.status + (1 | c.id), data = df.temp)

      lmer.date.rank.prey.repro.1 <- lmer(d.dependent ~ d.independent + i.rank + d.prey.density + c.reproductive.status + (1 | c.id), data = df.temp)
      lmer.date.rank.prey.repro.2 <- lmer(d.dependent ~ d.independent + i.rank * d.prey.density +  c.reproductive.status +  (1 | c.id), data = df.temp)
      lmer.date.rank.prey.repro.12 <- lmer(d.dependent ~ d.independent + i.rank + d.prey.density * c.reproductive.status +  (1 | c.id), data = df.temp)
      lmer.date.rank.prey.repro.22 <- lmer(d.dependent ~ d.independent + i.rank * d.prey.density + d.prey.density * c.reproductive.status +  (1 | c.id), data = df.temp)
      lmer.date.rank.age.repro.1 <- lmer(d.dependent ~ d.independent + i.rank + d.age.months +  c.reproductive.status + (1 | c.id), data = df.temp)
print("test35")
...
# print(str(clmm2.2))
print(clmm2.date$coefficients["d.independent"])

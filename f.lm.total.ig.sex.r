...
#########################################################################
  ...
  par(mfrow=c(2,3))
  lm.sex.age <- lm(d.blank.abs.total.ig ~ c.sex + c.age, data = df.igg.mean)
  print(summary(lm.sex.age))
  plot(lm.sex.age)
  hist(resid(lm.sex.age))  
  
  par(mfrow=c(2,3))
  lm.sex.age <- lm(d.blank.abs.total.ig ~ c.sex + c.age, data = df.igm.mean)
  print(summary(lm.sex.age))
  plot(lm.sex.age)
  hist(resid(lm.sex.age))  

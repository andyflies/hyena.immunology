...
#          axis.ticks =        theme.blank(),
  ...
  df.ec.data <- subset(df.master.bka, c.strain == "ec" & c.age == "adult" & c.id != "mp")   
  df.pm.data <- subset(df.master.bka, c.strain == "pm" & c.age == "adult" & c.id != "mp")   

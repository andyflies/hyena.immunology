...
#  df.temp.full$c.prey.density <- df.temp.full$c.prey.density.2.level
  print(df.temp.full$i.rank)
  df.temp.full$i.rank <- ((mean(df.temp.full$i.rank) - df.temp.full$i.rank) / sd(df.temp.full$i.rank))
  print(df.temp.full$i.rank)
  print(df.temp.full$d.prey.density)
#  df.temp.full$d.prey.density <- log10(df.temp.full$d.prey.density) 
  df.temp.full$d.prey.density <- (df.temp.full$d.prey.density) 
#  df.temp.full$d.prey.density <- ((mean(df.temp.full$d.prey.density) - df.temp.full$d.prey.density) / sd(df.temp.full$d.prey.density)) 
  print(df.temp.full$d.prey.density)

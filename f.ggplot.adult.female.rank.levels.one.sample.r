...
#          axis.ticks =        theme.blank(),
  ...
  df.ec.data <- subset(df.master.bka, c.strain == "ec" & c.sex == "f" & c.age == "adult" & i.sample.number.2 == 2)   # Get only the first adult sample from each individual for the E. coli data
  df.pm.data <- subset(df.master.bka, c.strain == "pm" & c.sex == "f" & c.age == "adult" & i.sample.number.2 == 2)   # Get only the first adult sample from each individual for the P. mirabilis data
  ...
  df.ec.mean <- aggregate(cbind(d.mic.90.level, i.rank, d.months.to.wean, i.sample.number, i.sample.number.2, d.sample.date, d.dob, d.age.months, d.mass,
...
#    + c.mom
  ...
  df.pm.mean <- aggregate(cbind(d.mic.90.level, i.rank, d.months.to.wean, i.sample.number, i.sample.number.2, d.sample.date, d.dob, d.age.months, d.mass,
    i.maternal.rank.at.birth, i.maternal.rank.at.sample, i.litter.rank, i.number.in.litter,d.minutes.blood, i.glucose.green,i.glucose.red,
    d.pcv, d.total.solids  
    ) 
    ~ c.id 
...
#    + c.mom
  ...
  df.ec.stderr <- aggregate(cbind(d.mic.90.level, i.rank, d.months.to.wean, i.sample.number, i.sample.number.2, d.sample.date, d.dob, d.age.months, d.mass,
    i.maternal.rank.at.birth, i.maternal.rank.at.sample, i.litter.rank, i.number.in.litter,d.minutes.blood, i.glucose.green,i.glucose.red,
    d.pcv, d.total.solids  
    ) 
    ~ c.id 
...
#    + c.mom
  ...
  df.pm.stderr <- aggregate(cbind(d.mic.90.level, i.rank, d.months.to.wean, i.sample.number, i.sample.number.2, d.sample.date, d.dob, d.age.months, d.mass,
    i.maternal.rank.at.birth, i.maternal.rank.at.sample, i.litter.rank, i.number.in.litter,d.minutes.blood, i.glucose.green,i.glucose.red,
    d.pcv, d.total.solids  
    ) 
    ~ c.id 

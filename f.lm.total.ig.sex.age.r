# source("f.lm.total.ig.sex.age.r")

# print(df.data[df.data$c.id=="mls", 1:10])
# df.temp <- subset(df.data, !(c.id == "mls" & c.age == "subadult"))
# print(df.temp[df.temp$c.id=="mls",])

f.lm.total.ig.sex.age <- function()
{

  df.igg.data <- subset(df.data, c.isotype.target == "IgG")   
  df.igm.data <- subset(df.data, c.isotype.target == "IgG")   
...
#########################################################################
  ...
  par(mfrow=c(2,3))
  lm.age <- lm(d.blank.abs.total.ig ~ c.age, data = df.igg.mean)
  print(summary(lm.age))
  plot(lm.age)
  hist(resid(lm.age))
  plot(d.blank.abs.total.ig ~ c.age, data = df.igg.mean)
  
  par(mfrow=c(2,3))
  lm.age <- lm(d.blank.abs.total.ig ~ c.age, data = df.igm.mean)
  print(summary(lm.age))
  plot(lm.age)
  hist(resid(lm.age))  
  plot(d.blank.abs.total.ig ~ c.age, data = df.igm.mean)
  ...
  plot(lm.sex)
  hist(resid(lm.sex))  
  boxplot(d.blank.abs.total.ig ~ c.sex, data = df.igg.mean)
  ...
  plot(lm.sex)
  hist(resid(lm.sex)) 
  boxplot(d.blank.abs.total.ig ~ c.sex, data = df.igm.mean) 

  par(mfrow=c(2,3))
  lm.sex.age <- lm(d.blank.abs.total.ig ~ c.sex + c.age + c.sex*c.age, data = df.igg.mean)
  print(summary(lm.sex.age))
  plot(lm.sex.age)
  hist(resid(lm.sex.age)) 
  boxplot(d.blank.abs.total.ig ~ c.sex + c.age, data = df.igg.mean) 
  
  par(mfrow=c(2,3))
  lm.sex.age <- lm(d.blank.abs.total.ig ~ c.sex + c.age + c.sex*c.age, data = df.igm.mean)
  print(summary(lm.sex.age))
  plot(lm.sex.age)
  hist(resid(lm.sex.age))  
  boxplot(d.blank.abs.total.ig ~ c.sex + c.age, data = df.igm.mean) 
